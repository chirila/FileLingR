...
First, set the fileroot - that's the folder that you want to analyze:
...
**The first time you use this code, RUN this section of the code before doing anything else; this will ensure that you have all the packages you need to run the rest of the code.**
...
download.file("https://github.com/dalejbarr/elan/blob/master/R/functions.R", "dalejbarr_functions.R")
source("dalejbarr_functions.R")


source("https://github.com/dalejbarr/elan/blob/59cf1016fc8e43926972cabc0229ce4d36a2adb3/R/functions.R")
```
